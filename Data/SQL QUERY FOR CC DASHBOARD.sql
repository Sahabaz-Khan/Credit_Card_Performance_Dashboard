...
COPY cc_detail 
FROM 'D:\POWER BI\Credit Card Financial Dashboard\credit_card.csv'
DELIMITER ','
CSV HEADER;

COPY cust_detail
FROM 'D:\POWER BI\Credit Card Financial Dashboard\customer.csv'
DELIMITER ','
CSV HEADER;
...
COPY cc_detail
FROM 'D:\POWER BI\Credit Card Financial Dashboard\cc_add.csv'
DELIMITER ','
CSV HEADER;
...
COPY cust_detail
FROM 'D:\POWER BI\Credit Card Financial Dashboard\cust_add.csv'
DELIMITER ','
CSV HEADER;
